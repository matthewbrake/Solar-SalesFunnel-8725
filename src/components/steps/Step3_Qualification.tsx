...
const Step3Qualification: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                <h3 className="text-lg font-semibold">What is your estimated credit score?</h3>
            ...
            <div>
                <h3 className="text-lg font-semibold">How interested are you?</h3>
            ...
            {/* Monthly Bill Slider - Only for Solar Path */}
            {isSolarPath && (
                <div>
            ...
            {/* Project Notes for Non-Solar Paths */}
            {!isSolarPath && (
                <div>
                    <label htmlFor="projectNotes" className="text-lg font-semibold">
                        Project Notes
                    </label>
                    <p className="text-sm text-text-secondary mb-3">Please describe what you're looking for. (Optional)</p>
                    <textarea
                        id="projectNotes"
                        rows={4}
                        className="block w-full px-4 py-3 border rounded-lg shadow-subtle transition duration-150 ease-in-out bg-background-surface border-border text-text-primary placeholder-text-subtle focus:ring-2 focus:ring-primary/30 focus:border-primary"
                        placeholder="e.g., I need a new central AC unit for a 2000 sq. ft. house..."
