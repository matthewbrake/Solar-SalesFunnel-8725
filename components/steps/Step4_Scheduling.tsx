...
const Step4Scheduling: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h2 className="text-2xl font-bold text-text-primary">Final Steps</h2>
                <p className="text-text-secondary mt-1">Upload your bills and schedule a consultation.</p>
            </div>

            {/* File Upload */}
            <div>
                <h3 className="text-lg font-semibold text-text-primary">Upload Your Last 4 Electric Bills</h3>
            ...
            {/* Scheduling */}
            <div>
                 <h3 className="text-lg font-semibold text-text-primary">Schedule Your Consultation</h3>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-3">
                    ...
                    <div>
                        <h4 className="font-semibold text-center mb-2 text-text-primary">{selectedDate ? selectedDate.toDateString() : "Select a date"}</h4>
                        {selectedDate && (
