...
import type { SolarDataSummary, GoogleSolarData } from '../../types';
...
const LoadingSpinner: React.FC = () => (
    <div className="flex flex-col items-center justify-center text-center p-8 space-y-4">
        ...
        <h3 className="text-xl font-semibold text-text-primary">Analyzing Your Roof...</h3>
...
const Step2aSolarAnalysis: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h2 className="text-2xl font-bold text-text-primary">Your Solar Potential Analysis</h2>
